...
```toml
[params]
  images = ["/cdn/theme/images/fu-default_1200x630_black-favicon.jpg"]
 ...
 # define which amp-elements you are using globally, these elements will be included in every page
  ...
  ampElements = ["amp-sidebar","amp-analytics"]
  ...
  alternatePageName = "Acme AMP" # alternative name for website structured data
  organizationLogo = "https://Acme.com/global-assets/fu20164/dist/images/schema-org/logo-600x51.png" # set organization logo for structured data
  organizationName = "Acme.com" # set organization name
  organizationAddress = "Hoogoorddreef 56S, 1101BE Amsterdam" # set organization address
  # socialProfiles = ["https://www.facebook.com/Acme/","http://instagram.com/yourProfile","http://www.linkedin.com/in/yourprofile","http://plus.google.com/your_profile"]  # https://twitter.com/Acme for sameAs in organization's structured data
  publisherName = "Acme" # publisher used in article schema
  publisherLogo = "https://Acme.com/global-assets/fu20164/dist/images/schema-org/logo-600x51.png" # https://developers.google.com/search/docs/data-types/articles#logo-guidelines
