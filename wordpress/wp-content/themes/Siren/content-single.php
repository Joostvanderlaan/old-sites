...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
			<?php
				...
				$image = aq_resize( $img_url, 980, 500, true ); //resize & crop the image
			?>
		
			<?php if($image) : ?> <a class="fancybox" href="<?php echo $img_url ?>"><img class="scale postimg" src="<?php echo $image ?>"/></a> <?php endif; ?>
		<?php the_content(); ?>
