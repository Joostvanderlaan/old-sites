...
register_nav_menus(
	array(
	'main left'=>__('Main Left'),
	'main right'=>__('Main Right'),
	)
);
...
#header{background:<?php echo of_get_option('header_bg', '#000' ) ?>;}

#footer-wrapper{background:<?php echo of_get_option('footer_bg', '#000' ) ?>;}
