...
if(!class_exists('Kmn_Func')) : // declare Kmn_Func class only if class has not been defined (working with Komoona Ads and Komoona AdSense plugin)
    ...
    class Kmn_Func {
        ...
        static private function komoona_options_engugue($type) {
            ...
            wp_register_style('jquery-ui-1.8.18.custom.css', KOMOONA_PLUGIN_URL . '/resources/jquery-ui-1.8.18.custom.css');
            wp_enqueue_style('jquery-ui-1.8.18.custom.css');
            wp_register_script('jquery-ui-1.8.18.custom.min.js', KOMOONA_PLUGIN_URL . '/resources/jquery-ui-1.8.18.custom.min.js', array ('jquery'));
        ...
        static private function komoona_get_currencies($currency) {
            echo '<option ' . ($currency === 'USD' ? 'selected="selected"' : '') . ' value="USD">' . translate('USD', 'komoona') . '</option>';
            echo '<option ' . ($currency === 'AUD' ? 'selected="selected"' : '') . ' value="AUD">' . translate('AUD', 'komoona') . '</option>';
            echo '<option ' . ($currency === 'CAD' ? 'selected="selected"' : '') . ' value="CAD">' . translate('CAD', 'komoona') . '</option>';
            echo '<option ' . ($currency === 'EUR' ? 'selected="selected"' : '') . ' value="EUR">' . translate('EUR', 'komoona') . '</option>';
            echo '<option ' . ($currency === 'JPY' ? 'selected="selected"' : '') . ' value="JPY">' . translate('JPY', 'komoona') . '</option>';
            echo '<option ' . ($currency === 'GBP' ? 'selected="selected"' : '') . ' value="GBP">' . translate('GBP', 'komoona') . '</option>';
        }
            ...
            ?>
                <div id="kmn-create-account">
                    ...
                    <form method="post" action="<?php echo str_replace('%7E', '~', $_SERVER['REQUEST_URI']); ?>" id="create-kmn-account">
                        ...
                        <br/>
                        <div style="margin-top: 10px;"><button class="komoona-ads"><?php _e('I want to sell ads directly', 'komoona'); ?></button></div>
                        <input id="kmn-direct-sales" type="checkbox" style="float: left;display: none;" name="kmn_direct_sales" />
                        <div id="kmn-direct-sales-div" style="padding: 5px 5px 5px 5px;width:715px;display: none;">
                            <div class="kmn-message" style="padding:5px;"><?php _e('&lsquo;Komoona Direct&rsquo; is a FREE, win-win solution, that helps increase your site&rsquo;s advertising income. Simply set your price and a small &lsquo;Advertise Here&rsquo; link will appear under your ad space Advertisers visiting your site will be able to buy out the ad space for a set period of time. When an ad is purchased, an email notification will be sent out to you asking you to approve the ad', 'komoona'); ?></div>
                            <div valign="top">
                                 <table class="form-table">
                                     <tr valign="top">
                                        ...
                                        ?>
                                        <input type="text" id="kmn-price" name="kmn_price" style="width:100px;" tabindex="<?php echo ($type === Kmn_Func::KOMOONA_ADSENSE) ? 6 : 7; ?>" autocomplete="off" value="<?php echo $price; ?>" />
                                        <a id="kmn-price-error" rel="validation-error" href="javascript:void(0);" onclick="return false;" title="<?php _e('Invalid price: please insert single ad unit price', 'komoona'); ?>"><img src="<?php echo KOMOONA_PLUGIN_URL; ?>resources/clear.png" alt="" height="21px" width="1px" border="0" /></a>
                                        <select id="kmn_currency" name="kmn_currency" tabindex="<?php echo ($type === Kmn_Func::KOMOONA_ADSENSE) ? 6 : 7; ?>" style="height:23px;width:140px;margin-left:5px;">
                                            <?php Kmn_Func::komoona_get_currencies($currency); ?>
                                        </select>
                                    ...
                                    <tr valign="top">
                                        <th scope="row"><?php _e('Your PayPal Account (email address)', 'komoona'); ?></th>
                                        <td>
                                            <input type="text" id="kmn-paypal" name="kmn_paypal" tabindex="<?php echo ($type === Kmn_Func::KOMOONA_ADSENSE) ? 7 : 8; ?>" style="width:250px;" value="<?php echo $post ? $_POST['kmn_paypal'] : ''; ?>" />
                                            <a id="kmn-paypal-error" rel="validation-error" href="javascript:void(0);" onclick="return false;" title="<?php _e('Please insert a valid PayPal account (email address)', 'komoona'); ?>"><img src="<?php echo KOMOONA_PLUGIN_URL; ?>resources/clear.png" alt="" height="21px" width="1px" border="0" /></a>
                                            <a onclick="return false;" href="javascript:void(0);" rel="help-tip" title="<?php _e('Advertisers will be directed to your PayPal account in order to complete payment', 'komoona'); ?>">
                                                <img width="12px" height="12px" alt="" src="<?php echo KOMOONA_PLUGIN_URL . 'resources/question.jpg'; ?>">
                                            </a>
                                        </td>
                                    </tr>
        ...
        static private function komoona_add_tag($type) { ?>
            <div id="kmn-add-tag"  style="display:none;">
                ...
                <form method="post" action="<?php echo str_replace('%7E', '~', $_SERVER['REQUEST_URI']); ?>" id="add-kmn-site">
                    ...
                    <div style="margin-top: 10px;"><button class="komoona-a-ads"><?php _e('I want to sell ads directly', 'komoona'); ?></button></div>
                    <input id="kmn-a-direct-sales" type="checkbox" style="float: left;display: none;" name="kmn_a_direct_sales" />
                    <div id="kmn-a-direct-sales-div" style="padding: 5px 5px 5px 5px;width:715px;display: none;">
                        <table class="form-table">
                             <tr valign="top">
                                <th scope="row"><?php _e('Single Ad Unit Price', 'komoona'); ?></th>
                                <td>
                                <?php
                                    $price = $post ? $_POST['kmn_a_price'] : '';
                                    $currency = $post ? $_POST['kmn_a_currency'] : 'USD';
                                ?>
                                <input type="text" id="kmn-a-price" name="kmn_a_price" style="width:100px;" tabindex="<?php echo ($type === Kmn_Func::KOMOONA_ADSENSE) ? 6 : 7; ?>" autocomplete="off" value="<?php echo $price; ?>" />
                                <a id="kmn-a-price-error" rel="validation-error" href="javascript:void(0);" onclick="return false;" title="<?php _e('Invalid price: please insert single ad unit price', 'komoona'); ?>"><img src="<?php echo KOMOONA_PLUGIN_URL; ?>resources/clear.png" alt="" height="21px" width="1px" border="0" /></a>
                                <select id="kmn_a_currency" name="kmn_a_currency" tabindex="<?php echo ($type === Kmn_Func::KOMOONA_ADSENSE) ? 6 : 7; ?>" style="height:23px;width:140px;margin-left:5px;">
                                    <?php Kmn_Func::komoona_get_currencies($currency); ?>
                                </select>
                                <a onclick="return false;" href="javascript:void(0);" rel="help-tip" title="<?php _e('By default, you set the price for 7 day ad. You can later change this and define price for additional periods (i.e. price for 30 day ad) from the control panel.', 'komoona'); ?>">
                                    <img width="12px" height="12px" alt="" src="<?php echo KOMOONA_PLUGIN_URL . 'resources/question.jpg'; ?>">
                            ...
                            <tr valign="top">
                                <th scope="row"><?php _e('Your PayPal Merchant Account', 'komoona'); ?></th>
                                <td>
                                    <input type="text" id="kmn-a-paypal" name="kmn_a_paypal" tabindex="<?php echo ($type === Kmn_Func::KOMOONA_ADSENSE) ? 7 : 8; ?>" style="width:250px;" value="<?php echo $post ? $_POST['kmn_a_paypal'] : ''; ?>" />
                                    <a id="kmn-a-paypal-error" rel="validation-error" href="javascript:void(0);" onclick="return false;" title="<?php _e('Please insert a valid PayPal account (email address)', 'komoona'); ?>"><img src="<?php echo KOMOONA_PLUGIN_URL; ?>resources/clear.png" alt="" height="21px" width="1px" border="0" /></a>
                                </td>
                            </tr>
                        </table>
                        <div class="kmn-message" style="padding:5px;">&lsquo;<?php _e('Komoona Direct', 'komoona'); ?>&rsquo; <?php _e('is a FREE, win-win solution, that helps increase your site&rsquo;s advertising income. Simply set your price and a small &lsquo;Advertise Here&rsquo; link will appear under your ad space Advertisers visiting your site will be able to buy out the ad space for a set period of time. When an ad is purchased, an email notification will be sent out to you asking you to approve the ad', 'komoona'); ?></div>
                    </div>
                    <div style="padding-top:5px;">
