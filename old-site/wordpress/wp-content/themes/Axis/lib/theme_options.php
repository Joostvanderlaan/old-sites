...
$options = array (
	...
	array("name" => "Default background image",
			"desc" => "Background image for pages without slideshow background ",
	...
	array(  "name" => "Select the slideshow transition effect",
	...
	array("name" => "Transition speed",
			"desc" => "Enter the transition speed in milliseconds ( 1000 = 1 sec).",
            "id" => $shortname."_speed",
        	"std" => "1000",
            "type" => "text"), 		
