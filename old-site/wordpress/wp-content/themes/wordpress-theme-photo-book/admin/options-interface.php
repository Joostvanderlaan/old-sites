...
function optionsframework_fields() {
    ...
    $output .= '</div>';
			 ...
			 $output .= '<div style="position:fixed; right:0px;top:200px;border:none" ><a target="_blank" href="http://blog.hhcolorlab.com/photography-theme-forum" title="photography theme forum"><img src="'.get_bloginfo('template_url').'/admin/images/techsupport.png" /></a></div>';

$output .='<img align="right" style="margin:40px 20px 0px 0px;" src="http://blog.hhcolorlab.com/wp-content/themes/HHColorLab/images/logo.gif" title="Brought to you by H&H Color Lab"  alt="Right Aligned" />';
