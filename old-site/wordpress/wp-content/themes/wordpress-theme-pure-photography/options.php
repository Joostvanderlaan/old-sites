...
function optionsframework_options() {
	...
	$menu_position = array("right" => "Right", "both" => "Left & Right" );
	//$heading_font = array(""=>"Default","1" => "Bebas", "2" => "Chunk", "3" => "Cicle", "4" => "Dekar", "5" => "Franchise", "6" => "Prociono", "7" => "Ripe", "8" => "Scriptina", "9" => "Sertig");
	
		$heading_font = array(""=>get_bloginfo('template_url')."/images/fonts/default.png","1" => get_bloginfo('template_url')."/images/fonts/bebas.png", "2" => get_bloginfo('template_url')."/images/fonts/chunkfive.png", "3" =>  get_bloginfo('template_url')."/images/fonts/cicle_gordita.png", "4" => get_bloginfo('template_url')."/images/fonts/dekar.png", "5" => get_bloginfo('template_url')."/images/fonts/franchise.png", "6" =>  get_bloginfo('template_url')."/images/fonts/prociono_tt.png", "7" => get_bloginfo('template_url')."/images/fonts/ripe.png", "8" => get_bloginfo('template_url')."/images/fonts/scriptina_pro.png", "9" => get_bloginfo('template_url')."/images/fonts/sertig.png");
	...
	$options[] = array( "name" => "Menu",
						"desc" => "Select the way you need your top menu. If you choose Right, only the Main Right menu will work on the menu manager",
						"id" => "menu_position",
						"std" => "both",
						"type" => "radio",
	...
	$options[] = array( "name" => "Header background color",
						"desc" => "Select your color for the header background",
						"id" => "header_bg",
						"std" => "#000000",
						"type" => "color");
	...
	$options[] = array( "name" => "Footer background color",
						"desc" => "Select your color for the footer background",
						"id" => "footer_bg",
						"std" => "#000000",
						"type" => "color");
