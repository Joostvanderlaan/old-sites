...
<div id="welcome-panel" class="welcome-panel">
	...
	<p class="about-description">Siren is a responsive WordPress theme. This is a WordPress 3+ ready theme with features like custom menu, featured images,
	...
	<div class="welcome-panel-column-container">
		...
		<div class="guide-panel-column" style="width:80%">
		<h4><span class="icon16 icon-settings"></span>Theme Customization </h4>
		<p>The theme comes with a customization setting. YOU will be able to adjust the color scheme, link color link hover color etc via the customization panel. Please check the screencast below to see it in action.  </p>
		<p><iframe src="http://www.screenr.com/embed/ptI8" width="650" height="396" frameborder="0"></iframe></p>
