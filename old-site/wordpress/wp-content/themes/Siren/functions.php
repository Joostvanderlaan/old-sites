...
$example_update_checker = new ThemeUpdateChecker(
	'Siren',                                            //Theme folder name, AKA "slug". 
	'http://www.fabthemes.com/versions/siren.json' //URL of the metadata file.
);
...
function web2feel_widgets_init() {
	...
	register_sidebar(array(
		'name' => 'Footer',
		'before_widget' => '<div class="grid-3"><li class="botwid %2$s">',
		'after_widget' => '</li> </div>',
...
function web2feel_scripts() {
	...
	wp_enqueue_style( 'rwdgrid', get_template_directory_uri() . '/css/rwdgrid.css');
...
{
  $colors = array();
  $colors[] = array( 'slug'=>'color_scheme', 'default' => '#FC541F', 'label' => __( 'Color scheme', 'YOUR_THEME_NAME' ) );
  $colors[] = array( 'slug'=>'link_color', 'default' => '#FC541F', 'label' => __( 'Link color', 'YOUR_THEME_NAME' ) );
  $colors[] = array( 'slug'=>'hover_link_color', 'default' => '#C93508', 'label' => __( 'Link color on hover', 'YOUR_THEME_NAME' ) );
...
function mytheme_customize_css()
{
    ?>
         <style type="text/css">
            .top { border-bottom:10px solid <?php echo get_option('color_scheme'); ?>; }
            .readon, #submenu li ul { background:<?php echo get_option('color_scheme'); ?> }
            .entry-header{border-left:5px solid <?php echo get_option('color_scheme');?> }	                   
